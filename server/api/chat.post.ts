  ...
  try {
    ...
    if (userData.history.length === 0) {
      userData.history.push({
        role: "system",
        content: `Sen, kapsamlı bir otomobil bilgi ve arıza tespit asistanısın, arabalar dışında herhangi bir soruya cevap vermeyeceksin eğer arabalar dışında herhangi bir soru gelirse nazikçe cevaplayamacağınız belirt, günümüz araç marka modelleriyle ilgili sorulan sorulara da cevap verebilirsin. Görevlerin şunları içerir:
